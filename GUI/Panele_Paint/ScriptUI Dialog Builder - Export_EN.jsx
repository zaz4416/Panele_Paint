...
var m_BtnSimplify = group2.add("button", undefined, undefined, {name: "m_BtnSimplify"}); 
    m_BtnSimplify.text = "( To simple paht )"; 
...
var m_BtnFillSelectedArea = group2.add("button", undefined, undefined, {name: "m_BtnFillSelectedArea"}); 
    m_BtnFillSelectedArea.text = "( Fill selected item )"; 

var m_BtnGpExtrudingPtn = group2.add("button", undefined, undefined, {name: "m_BtnGpExtrudingPtn"}); 
    m_BtnGpExtrudingPtn.text = "To extruding Pattern"; 
...
var m_BtnMakeGroup = group3.add("button", undefined, undefined, {name: "m_BtnMakeGroup"}); 
    m_BtnMakeGroup.text = "Make Group"; 

var m_MkGroupName = group3.add('edittext {properties: {name: "m_MkGroupName"}}'); 
    m_MkGroupName.text = "<GpItem>"; 

// GROUP4
// ======
var group4 = Dlg.add("group", undefined, {name: "group4"}); 
...
// OBJPANNEL02
// ===========
var objPannel02 = group4.add("panel", undefined, undefined, {name: "objPannel02"}); 
...
var m_RadioBtnBlobBrush = panel1.add("radiobutton", undefined, undefined, {name: "m_RadioBtnBlobBrush"}); 
    m_RadioBtnBlobBrush.text = "Blib Brush"; 
...
var m_RadioBtnObjectSelect = objPannel02.add("radiobutton", undefined, undefined, {name: "m_RadioBtnObjectSelect"}); 
    m_RadioBtnObjectSelect.text = "Select grouo"; 

var m_RadioBtnSelAround = objPannel02.add("radiobutton", undefined, undefined, {name: "m_RadioBtnSelAround"}); 
    m_RadioBtnSelAround.text = "Direct lasso tool"; 
...
var m_BtnCancel = group5.add("button", undefined, undefined, {name: "m_BtnCancel"}); 
