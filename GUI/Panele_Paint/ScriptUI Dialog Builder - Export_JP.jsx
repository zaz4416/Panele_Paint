...
var m_BtnDiaplySwatch = group2.add("button", undefined, undefined, {name: "m_BtnDiaplySwatch"}); 
    m_BtnDiaplySwatch.text = "スウォッチを表示"; 
